  ...
  return (
    <div className="group relative flex min-h-[380] w-full max-w-[400px] flex-col overflow-hidden rounded-xl bg-white shadow-md transition-all hover:shadow-lg md:min-h-[438px]">
      <Link
        ...
        className="flex-center flex-grow bg-gray-50 bg-cover bg-center tex-grey-500 h-[200px]"
      />
      {/* is event creator */}
      {isEventCreator && !hidePrice && (
        <div className="absolute right-2 top-2 flex flex-col gap-4 rounded-xl bg-grey-400/15 p-3 shadow-sm hover:shadow-md transition-all">
